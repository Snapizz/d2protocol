...
var IdentificationAccountForceMessage = module.exports = function() {
    this.forcedAccountLogin = "";

    return this;
};

require('util').inherits(IdentificationAccountForceMessage, require('./identification-message.js'));
