...
var VersionExtended = require('../../types/version/version-extended.js').VersionExtended;

var IdentificationAccountForceMessage = function() {
    this.forcedAccountLogin = "";
};

require('util').inherits(IdentificationAccountForceMessage, require('./identification-message.js').IdentificationMessage);
