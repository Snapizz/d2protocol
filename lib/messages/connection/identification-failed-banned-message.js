...
var IdentificationFailedBannedMessage = module.exports = function() {
    this.banEndDate = 0;

    return this;
};

require('util').inherits(IdentificationFailedBannedMessage, require('./identification-failed-message.js'));
