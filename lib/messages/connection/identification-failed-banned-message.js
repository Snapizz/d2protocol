...
require('util').inherits(IdentificationFailedBannedMessage, require('./identification-failed-message.js').class);
...
IdentificationFailedBannedMessage.prototype.serializeAs_IdentificationFailedBannedMessage = function(param1) {
    this.serializeAs_IdentificationFailedMessageAs_IdentificationFailedMessage(param1);
