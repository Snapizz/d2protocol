...
var SelectedServerDataExtendedMessage = module.exports = function() {
    this.serverIds = [];

    return this;
};

require('util').inherits(SelectedServerDataExtendedMessage, require('./selected-server-data-message.js'));
