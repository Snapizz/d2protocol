...
var AchievementFinishedInformationMessage = module.exports = function() {
    this.name = "";
    this.playerId = 0;
...
require('util').inherits(AchievementFinishedInformationMessage, require('./achievement-finished-message.js'));
