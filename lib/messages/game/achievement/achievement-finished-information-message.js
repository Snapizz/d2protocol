...
require('util').inherits(AchievementFinishedInformationMessage, require('./achievement-finished-message.js').class);
...
AchievementFinishedInformationMessage.prototype.serializeAs_AchievementFinishedInformationMessage = function(param1) {
    this.serializeAs_AchievementFinishedMessageAs_AchievementFinishedMessage(param1);
