...
var AchievementRewardable = require('../../../types/game/achievement/achievement-rewardable.js').class;

var AchievementListMessage = module.exports = function() {
...
require('util').inherits(AchievementListMessage, d2com.NetworkMessage.class);
