...
var AbstractGameActionWithAckMessage = module.exports = function() {
    this.waitAckId = 0;

    return this;
};

require('util').inherits(AbstractGameActionWithAckMessage, require('./abstract-game-action-message.js'));
