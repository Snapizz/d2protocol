...
var AbstractGameActionFightTargetedAbilityMessage = module.exports = function() {
    this.targetId = 0;
...
require('util').inherits(AbstractGameActionFightTargetedAbilityMessage, require('../abstract-game-action-message.js'));
