...
var GameActionFightCarryCharacterMessage = module.exports = function() {
    this.targetId = 0;
    this.cellId = 0;
...
require('util').inherits(GameActionFightCarryCharacterMessage, require('../abstract-game-action-message.js'));
