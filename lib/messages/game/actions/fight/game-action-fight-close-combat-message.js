...
var GameActionFightCloseCombatMessage = module.exports = function() {
    this.weaponGenericId = 0;

    return this;
};

require('util').inherits(GameActionFightCloseCombatMessage, require('./abstract-game-action-fight-targeted-ability-message.js'));
