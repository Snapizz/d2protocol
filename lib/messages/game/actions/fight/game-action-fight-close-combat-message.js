...
require('util').inherits(GameActionFightCloseCombatMessage, require('./abstract-game-action-fight-targeted-ability-message.js').AbstractGameActionFightTargetedAbilityMessage);
