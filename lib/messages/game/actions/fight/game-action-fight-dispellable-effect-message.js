...
var AbstractFightDispellableEffect = require('../../../../types/game/actions/fight/abstract-fight-dispellable-effect.js').AbstractFightDispellableEffect;

var GameActionFightDispellableEffectMessage = function() {
    this.effect = new AbstractFightDispellableEffect();
};

require('util').inherits(GameActionFightDispellableEffectMessage, require('../abstract-game-action-message.js').AbstractGameActionMessage);
