...
var GameActionFightDispellableEffectMessage = module.exports = function() {
    this.effect = new AbstractFightDispellableEffect();

    return this;
};

require('util').inherits(GameActionFightDispellableEffectMessage, require('../abstract-game-action-message.js'));
