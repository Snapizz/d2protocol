...
var GameActionFightDodgePointLossMessage = module.exports = function() {
    this.targetId = 0;
    this.amount = 0;
...
require('util').inherits(GameActionFightDodgePointLossMessage, require('../abstract-game-action-message.js'));
