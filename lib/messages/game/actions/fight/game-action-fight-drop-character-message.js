...
var GameActionFightDropCharacterMessage = module.exports = function() {
    this.targetId = 0;
    this.cellId = 0;
...
require('util').inherits(GameActionFightDropCharacterMessage, require('../abstract-game-action-message.js'));
