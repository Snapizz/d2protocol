...
var GameActionFightExchangePositionsMessage = module.exports = function() {
    this.targetId = 0;
    this.casterCellId = 0;
    this.targetCellId = 0;
...
require('util').inherits(GameActionFightExchangePositionsMessage, require('../abstract-game-action-message.js'));
