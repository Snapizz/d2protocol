...
require('util').inherits(GameActionFightInvisibleObstacleMessage, require('../abstract-game-action-message.js').AbstractGameActionMessage);
...
module.exports.GameActionFightInvisibleObstacleMessage = GameActionFightInvisibleObstacleMessage;