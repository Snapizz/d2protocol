...
var GameActionFightLifeAndShieldPointsLostMessage = module.exports = function() {
    this.shieldLoss = 0;

    return this;
};

require('util').inherits(GameActionFightLifeAndShieldPointsLostMessage, require('./game-action-fight-life-points-lost-message.js'));
