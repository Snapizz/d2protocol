...
var GameActionFightLifePointsLostMessage = module.exports = function() {
    this.targetId = 0;
    this.loss = 0;
...
require('util').inherits(GameActionFightLifePointsLostMessage, require('../abstract-game-action-message.js'));
