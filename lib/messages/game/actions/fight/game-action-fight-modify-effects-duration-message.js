...
var GameActionFightModifyEffectsDurationMessage = module.exports = function() {
    this.targetId = 0;
    this.delta = 0;
...
require('util').inherits(GameActionFightModifyEffectsDurationMessage, require('../abstract-game-action-message.js'));
