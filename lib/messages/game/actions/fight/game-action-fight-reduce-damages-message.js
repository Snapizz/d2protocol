...
var GameActionFightReduceDamagesMessage = module.exports = function() {
    this.targetId = 0;
    this.amount = 0;
...
require('util').inherits(GameActionFightReduceDamagesMessage, require('../abstract-game-action-message.js'));
