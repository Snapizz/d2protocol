...
require('util').inherits(GameActionFightSpellCastMessage, require('./abstract-game-action-fight-targeted-ability-message.js').class);
...
GameActionFightSpellCastMessage.prototype.serializeAs_GameActionFightSpellCastMessage = function(param1) {
    this.serializeAs_AbstractGameActionFightTargetedAbilityMessageAs_AbstractGameActionFightTargetedAbilityMessage(param1);
    if (this.spellId < 0) {
