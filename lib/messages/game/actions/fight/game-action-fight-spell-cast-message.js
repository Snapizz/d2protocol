...
var GameActionFightSpellCastMessage = module.exports = function() {
    this.spellId = 0;
    this.spellLevel = 0;
    this.portalsIds = [];
...
require('util').inherits(GameActionFightSpellCastMessage, require('./abstract-game-action-fight-targeted-ability-message.js'));
