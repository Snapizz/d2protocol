...
var GameActionFightSpellCooldownVariationMessage = module.exports = function() {
    this.targetId = 0;
    this.spellId = 0;
    this.value = 0;
...
require('util').inherits(GameActionFightSpellCooldownVariationMessage, require('../abstract-game-action-message.js'));
