...
var GameActionFightSpellImmunityMessage = module.exports = function() {
    this.targetId = 0;
    this.spellId = 0;
...
require('util').inherits(GameActionFightSpellImmunityMessage, require('../abstract-game-action-message.js'));
