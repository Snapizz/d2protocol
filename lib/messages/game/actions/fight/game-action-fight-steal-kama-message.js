...
var GameActionFightStealKamaMessage = module.exports = function() {
    this.targetId = 0;
    this.amount = 0;
...
require('util').inherits(GameActionFightStealKamaMessage, require('../abstract-game-action-message.js'));
