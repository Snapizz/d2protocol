...
var GameActionFightTeleportOnSameMapMessage = module.exports = function() {
    this.targetId = 0;
    this.cellId = 0;
...
require('util').inherits(GameActionFightTeleportOnSameMapMessage, require('../abstract-game-action-message.js'));
