...
var GameActionFightThrowCharacterMessage = module.exports = function() {
    this.targetId = 0;
    this.cellId = 0;
...
require('util').inherits(GameActionFightThrowCharacterMessage, require('../abstract-game-action-message.js'));
