...
var GameActionFightTriggerEffectMessage = module.exports = function() {


    return this;
};

require('util').inherits(GameActionFightTriggerEffectMessage, require('./game-action-fight-dispell-effect-message.js'));
