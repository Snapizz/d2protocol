...
var GameActionFightTriggerGlyphTrapMessage = module.exports = function() {
    this.markId = 0;
...
require('util').inherits(GameActionFightTriggerGlyphTrapMessage, require('../abstract-game-action-message.js'));
