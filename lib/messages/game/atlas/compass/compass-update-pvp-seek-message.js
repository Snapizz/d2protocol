...
require('util').inherits(CompassUpdatePvpSeekMessage, require('./compass-update-message.js').class);
...
CompassUpdatePvpSeekMessage.prototype.serializeAs_CompassUpdatePvpSeekMessage = function(param1) {
    this.serializeAs_CompassUpdateMessageAs_CompassUpdateMessage(param1);
    if (this.memberId < 0) {
