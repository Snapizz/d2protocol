...
var AbstractSocialGroupInfos = require('../../../types/game/social/abstract-social-group-infos.js').class;

var BasicWhoIsMessage = module.exports = function() {
    this.self = false;
    this.position = -1;
...
require('util').inherits(BasicWhoIsMessage, d2com.NetworkMessage.class);
