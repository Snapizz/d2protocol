...
var RemodelingInformation = require('../../../../types/game/character/choice/remodeling-information.js').RemodelingInformation;

var CharacterReplayWithRemodelRequestMessage = function() {
    this.remodel = new RemodelingInformation();
};

require('util').inherits(CharacterReplayWithRemodelRequestMessage, require('../replay/character-replay-request-message.js').CharacterReplayRequestMessage);
