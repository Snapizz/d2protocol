...
var CharacterReplayWithRemodelRequestMessage = module.exports = function() {
    this.remodel = new RemodelingInformation();

    return this;
};

require('util').inherits(CharacterReplayWithRemodelRequestMessage, require('../replay/character-replay-request-message.js'));
