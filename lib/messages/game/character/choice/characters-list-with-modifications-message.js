...
require('util').inherits(CharactersListWithModificationsMessage, require('./characters-list-message.js').class);
...
CharactersListWithModificationsMessage.prototype.serializeAs_CharactersListWithModificationsMessage = function(param1) {
    this.serializeAs_CharactersListMessageAs_CharactersListMessage(param1);
