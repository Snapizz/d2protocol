...
var CharacterToRecolorInformation = require('../../../../types/game/character/choice/character-to-recolor-information.js').CharacterToRecolorInformation;
var CharacterToRelookInformation = require('../../../../types/game/character/choice/character-to-relook-information.js').CharacterToRelookInformation;
var CharacterBaseInformations = require('../../../../types/game/character/choice/character-base-informations.js').CharacterBaseInformations;
...
require('util').inherits(CharactersListWithModificationsMessage, require('./characters-list-message.js').CharactersListMessage);

module.exports = function() {
    return new CharactersListWithModificationsMessage();
};
