...
var CharacterToRemodelInformations = require('../../../../types/game/character/choice/character-to-remodel-informations.js').CharacterToRemodelInformations;
...
require('util').inherits(CharactersListWithRemodelingMessage, require('./characters-list-message.js').CharactersListMessage);
