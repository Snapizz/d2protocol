...
var CharacterLevelUpInformationMessage = module.exports = function() {
    this.name = "";
    this.id = 0;
...
require('util').inherits(CharacterLevelUpInformationMessage, require('./character-level-up-message.js'));
