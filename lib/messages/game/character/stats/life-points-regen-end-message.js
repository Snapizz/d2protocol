...
require('util').inherits(LifePointsRegenEndMessage, require('./update-life-points-message.js').class);
...
LifePointsRegenEndMessage.prototype.serializeAs_LifePointsRegenEndMessage = function(param1) {
    this.serializeAs_UpdateLifePointsMessageAs_UpdateLifePointsMessage(param1);
