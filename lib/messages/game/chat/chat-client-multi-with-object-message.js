...
require('util').inherits(ChatClientMultiWithObjectMessage, require('./chat-client-multi-message.js').class);
...
ChatClientMultiWithObjectMessage.prototype.serializeAs_ChatClientMultiWithObjectMessage = function(param1) {
    this.serializeAs_ChatClientMultiMessageAs_ChatClientMultiMessage(param1);
