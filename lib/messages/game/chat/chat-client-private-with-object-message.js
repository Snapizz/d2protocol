...
var ChatClientPrivateWithObjectMessage = module.exports = function() {
    this.objects = [];

    return this;
};

require('util').inherits(ChatClientPrivateWithObjectMessage, require('./chat-client-private-message.js'));
