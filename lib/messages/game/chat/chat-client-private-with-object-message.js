...
require('util').inherits(ChatClientPrivateWithObjectMessage, require('./chat-client-private-message.js').class);
...
ChatClientPrivateWithObjectMessage.prototype.serializeAs_ChatClientPrivateWithObjectMessage = function(param1) {
    this.serializeAs_ChatClientPrivateMessageAs_ChatClientPrivateMessage(param1);
