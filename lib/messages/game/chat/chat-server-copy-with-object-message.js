...
require('util').inherits(ChatServerCopyWithObjectMessage, require('./chat-server-copy-message.js').class);
...
ChatServerCopyWithObjectMessage.prototype.serializeAs_ChatServerCopyWithObjectMessage = function(param1) {
    this.serializeAs_ChatServerCopyMessageAs_ChatServerCopyMessage(param1);
