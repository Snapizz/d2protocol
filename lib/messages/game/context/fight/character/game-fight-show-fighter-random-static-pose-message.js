...
var GameFightShowFighterRandomStaticPoseMessage = module.exports = function() {


    return this;
};

require('util').inherits(GameFightShowFighterRandomStaticPoseMessage, require('./game-fight-show-fighter-message.js'));
