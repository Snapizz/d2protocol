...
var GameFightPlacementSwapPositionsCancelMessage = module.exports = function() {
    this.requestId = 0;

    return this;
};

require('util').inherits(GameFightPlacementSwapPositionsCancelMessage, d2com.NetworkMessage.class);
