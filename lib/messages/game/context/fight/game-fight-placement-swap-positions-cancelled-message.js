...
var GameFightPlacementSwapPositionsCancelledMessage = module.exports = function() {
    this.requestId = 0;
    this.cancellerId = 0;
...
require('util').inherits(GameFightPlacementSwapPositionsCancelledMessage, d2com.NetworkMessage.class);
