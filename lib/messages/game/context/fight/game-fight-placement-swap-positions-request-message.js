...
var GameFightPlacementSwapPositionsRequestMessage = module.exports = function() {
    this.requestedId = 0;

    return this;
};

require('util').inherits(GameFightPlacementSwapPositionsRequestMessage, require('./game-fight-placement-position-request-message.js'));
