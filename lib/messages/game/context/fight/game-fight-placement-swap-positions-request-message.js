...
require('util').inherits(GameFightPlacementSwapPositionsRequestMessage, require('./game-fight-placement-position-request-message.js').GameFightPlacementPositionRequestMessage);
