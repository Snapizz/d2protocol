...
require('util').inherits(GameFightResumeMessage, require('./game-fight-spectate-message.js').class);
...
GameFightResumeMessage.prototype.serializeAs_GameFightResumeMessage = function(param1) {
    this.serializeAs_GameFightSpectateMessageAs_GameFightSpectateMessage(param1);
