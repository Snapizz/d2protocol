...
var GameFightResumeWithSlavesMessage = module.exports = function() {
    this.slavesInfo = [];

    return this;
};

require('util').inherits(GameFightResumeWithSlavesMessage, require('./game-fight-resume-message.js'));
