...
require('util').inherits(GameFightSpectatorJoinMessage, require('./game-fight-join-message.js').class);
...
GameFightSpectatorJoinMessage.prototype.serializeAs_GameFightSpectatorJoinMessage = function(param1) {
    this.serializeAs_GameFightJoinMessageAs_GameFightJoinMessage(param1);
