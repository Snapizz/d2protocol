...
var GameCautiousMapMovementRequestMessage = module.exports = function() {


    return this;
};

require('util').inherits(GameCautiousMapMovementRequestMessage, require('./game-map-movement-request-message.js'));
