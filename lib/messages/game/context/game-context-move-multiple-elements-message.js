...
var EntityMovementInformations = require('../../../types/game/context/entity-movement-informations.js').EntityMovementInformations;

var GameContextMoveMultipleElementsMessage = function() {
    this.movements = [];
};

require('util').inherits(GameContextMoveMultipleElementsMessage, d2com.NetworkMessage.class);
