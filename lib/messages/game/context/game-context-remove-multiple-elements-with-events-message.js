...
require('util').inherits(GameContextRemoveMultipleElementsWithEventsMessage, require('./game-context-remove-multiple-elements-message.js').GameContextRemoveMultipleElementsMessage);
