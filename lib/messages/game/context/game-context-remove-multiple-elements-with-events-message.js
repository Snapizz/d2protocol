...
require('util').inherits(GameContextRemoveMultipleElementsWithEventsMessage, require('./game-context-remove-multiple-elements-message.js').class);
...
GameContextRemoveMultipleElementsWithEventsMessage.prototype.serializeAs_GameContextRemoveMultipleElementsWithEventsMessage = function(param1) {
    this.serializeAs_GameContextRemoveMultipleElementsMessageAs_GameContextRemoveMultipleElementsMessage(param1);
