...
var GameRolePlayDelayedActionFinishedMessage = module.exports = function() {
...
require('util').inherits(GameRolePlayDelayedActionFinishedMessage, d2com.NetworkMessage.class);
