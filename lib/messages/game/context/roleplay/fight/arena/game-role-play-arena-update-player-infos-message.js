...
var GameRolePlayArenaUpdatePlayerInfosMessage = module.exports = function() {
    this.rank = 0;
...
require('util').inherits(GameRolePlayArenaUpdatePlayerInfosMessage, d2com.NetworkMessage.class);
