...
require('util').inherits(GameRolePlayShowActorWithEventMessage, require('./game-role-play-show-actor-message.js').class);
...
GameRolePlayShowActorWithEventMessage.prototype.serializeAs_GameRolePlayShowActorWithEventMessage = function(param1) {
    this.serializeAs_GameRolePlayShowActorMessageAs_GameRolePlayShowActorMessage(param1);
