...
var HouseKickIndoorMerchantRequestMessage = module.exports = function() {
    this.cellId = 0;

    return this;
};

require('util').inherits(HouseKickIndoorMerchantRequestMessage, d2com.NetworkMessage.class);
