...
require('util').inherits(HouseLockFromInsideRequestMessage, require('../lockable/lockable-change-code-message.js').class);
...
HouseLockFromInsideRequestMessage.prototype.serializeAs_HouseLockFromInsideRequestMessage = function(param1) {
    this.serializeAs_LockableChangeCodeMessageAs_LockableChangeCodeMessage(param1);
};
