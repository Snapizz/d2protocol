...
var JobCrafterDirectoryListRequestMessage = module.exports = function() {
    this.jobId = 0;

    return this;
};

require('util').inherits(JobCrafterDirectoryListRequestMessage, d2com.NetworkMessage.class);
