...
require('util').inherits(JobMultiCraftAvailableSkillsMessage, require('./job-allow-multi-craft-request-message.js').class);
...
JobMultiCraftAvailableSkillsMessage.prototype.serializeAs_JobMultiCraftAvailableSkillsMessage = function(param1) {
    this.serializeAs_JobAllowMultiCraftRequestMessageAs_JobAllowMultiCraftRequestMessage(param1);
    if (this.playerId < 0) {
