...
var JobMultiCraftAvailableSkillsMessage = module.exports = function() {
    this.playerId = 0;
    this.skills = [];
...
require('util').inherits(JobMultiCraftAvailableSkillsMessage, require('./job-allow-multi-craft-request-message.js'));
