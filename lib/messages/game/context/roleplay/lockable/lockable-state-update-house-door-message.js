...
var LockableStateUpdateHouseDoorMessage = module.exports = function() {
    this.houseId = 0;

    return this;
};

require('util').inherits(LockableStateUpdateHouseDoorMessage, require('./lockable-state-update-abstract-message.js'));
