...
require('util').inherits(LockableStateUpdateHouseDoorMessage, require('./lockable-state-update-abstract-message.js').class);
...
LockableStateUpdateHouseDoorMessage.prototype.serializeAs_LockableStateUpdateHouseDoorMessage = function(param1) {
    this.serializeAs_LockableStateUpdateAbstractMessageAs_LockableStateUpdateAbstractMessage(param1);
    if (this.houseId < 0) {
