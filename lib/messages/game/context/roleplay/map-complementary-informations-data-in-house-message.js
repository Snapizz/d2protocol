...
var HouseInformationsInside = require('../../../../types/game/house/house-informations-inside.js').class;
...
var MapComplementaryInformationsDataInHouseMessage = module.exports = function() {
    this.currentHouse = new HouseInformationsInside();

    return this;
};

require('util').inherits(MapComplementaryInformationsDataInHouseMessage, require('./map-complementary-informations-data-message.js'));
