...
var MapComplementaryInformationsDataMessage = module.exports = function() {
    this.subAreaId = 0;
    this.mapId = 0;
    this.houses = [];
    this.actors = [];
...
require('util').inherits(MapComplementaryInformationsDataMessage, d2com.NetworkMessage.class);
