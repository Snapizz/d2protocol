...
var MapComplementaryInformationsWithCoordsMessage = module.exports = function() {
    this.worldX = 0;
    this.worldY = 0;
...
require('util').inherits(MapComplementaryInformationsWithCoordsMessage, require('./map-complementary-informations-data-message.js'));
