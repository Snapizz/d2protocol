...
var MapRunningFightDetailsExtendedMessage = module.exports = function() {
    this.namedPartyTeams = [];

    return this;
};

require('util').inherits(MapRunningFightDetailsExtendedMessage, require('./map-running-fight-details-message.js'));
