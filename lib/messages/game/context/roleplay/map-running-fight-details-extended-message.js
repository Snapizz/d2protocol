...
require('util').inherits(MapRunningFightDetailsExtendedMessage, require('./map-running-fight-details-message.js').class);
...
MapRunningFightDetailsExtendedMessage.prototype.serializeAs_MapRunningFightDetailsExtendedMessage = function(param1) {
    this.serializeAs_MapRunningFightDetailsMessageAs_MapRunningFightDetailsMessage(param1);
