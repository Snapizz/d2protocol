...
require('util').inherits(AllianceTaxCollectorDialogQuestionExtendedMessage, require('./tax-collector-dialog-question-extended-message.js').TaxCollectorDialogQuestionExtendedMessage);
