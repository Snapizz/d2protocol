...
require('util').inherits(TaxCollectorDialogQuestionExtendedMessage, require('./tax-collector-dialog-question-basic-message.js').TaxCollectorDialogQuestionBasicMessage);
