...
var TaxCollectorDialogQuestionExtendedMessage = module.exports = function() {
    this.maxPods = 0;
    this.prospecting = 0;
    this.wisdom = 0;
...
require('util').inherits(TaxCollectorDialogQuestionExtendedMessage, require('./tax-collector-dialog-question-basic-message.js'));
