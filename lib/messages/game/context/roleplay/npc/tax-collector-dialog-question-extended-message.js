...
require('util').inherits(TaxCollectorDialogQuestionExtendedMessage, require('./tax-collector-dialog-question-basic-message.js').class);
...
TaxCollectorDialogQuestionExtendedMessage.prototype.serializeAs_TaxCollectorDialogQuestionExtendedMessage = function(param1) {
    this.serializeAs_TaxCollectorDialogQuestionBasicMessageAs_TaxCollectorDialogQuestionBasicMessage(param1);
    if (this.maxPods < 0) {
