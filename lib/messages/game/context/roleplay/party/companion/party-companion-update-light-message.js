...
var PartyCompanionUpdateLightMessage = module.exports = function() {
    this.indexId = 0;

    return this;
};

require('util').inherits(PartyCompanionUpdateLightMessage, require('../party-update-light-message.js'));
