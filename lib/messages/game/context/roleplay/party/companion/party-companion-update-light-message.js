...
require('util').inherits(PartyCompanionUpdateLightMessage, require('../party-update-light-message.js').class);
...
PartyCompanionUpdateLightMessage.prototype.serializeAs_PartyCompanionUpdateLightMessage = function(param1) {
    this.serializeAs_PartyUpdateLightMessageAs_PartyUpdateLightMessage(param1);
    if (this.indexId < 0) {
