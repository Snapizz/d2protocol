...
var DungeonPartyFinderAvailableDungeonsMessage = module.exports = function() {
    this.dungeonIds = [];

    return this;
};

require('util').inherits(DungeonPartyFinderAvailableDungeonsMessage, d2com.NetworkMessage.class);
