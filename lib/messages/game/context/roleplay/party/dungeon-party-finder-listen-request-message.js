...
var DungeonPartyFinderListenRequestMessage = module.exports = function() {
    this.dungeonId = 0;

    return this;
};

require('util').inherits(DungeonPartyFinderListenRequestMessage, d2com.NetworkMessage.class);
