...
var DungeonPartyFinderRegisterSuccessMessage = module.exports = function() {
    this.dungeonIds = [];

    return this;
};

require('util').inherits(DungeonPartyFinderRegisterSuccessMessage, d2com.NetworkMessage.class);
