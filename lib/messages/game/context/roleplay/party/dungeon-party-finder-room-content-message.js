...
var DungeonPartyFinderPlayer = require('../../../../../types/game/context/roleplay/party/dungeon-party-finder-player.js').DungeonPartyFinderPlayer;
...
require('util').inherits(DungeonPartyFinderRoomContentMessage, d2com.NetworkMessage.class);
