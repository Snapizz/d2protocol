...
var PartyCancelInvitationNotificationMessage = module.exports = function() {
    this.cancelerId = 0;
    this.guestId = 0;
...
require('util').inherits(PartyCancelInvitationNotificationMessage, require('./abstract-party-event-message.js'));
