...
var PartyInvitationCancelledForGuestMessage = module.exports = function() {
    this.cancelerId = 0;

    return this;
};

require('util').inherits(PartyInvitationCancelledForGuestMessage, require('./abstract-party-message.js'));
