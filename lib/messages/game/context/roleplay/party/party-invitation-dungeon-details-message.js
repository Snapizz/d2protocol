...
var PartyInvitationMemberInformations = require('../../../../../types/game/context/roleplay/party/party-invitation-member-informations.js').class;
...
require('util').inherits(PartyInvitationDungeonDetailsMessage, require('./party-invitation-details-message.js').class);
...
PartyInvitationDungeonDetailsMessage.prototype.serializeAs_PartyInvitationDungeonDetailsMessage = function(param1) {
    this.serializeAs_PartyInvitationDetailsMessageAs_PartyInvitationDetailsMessage(param1);
    if (this.dungeonId < 0) {
