...
var PartyInvitationDungeonDetailsMessage = module.exports = function() {
    this.dungeonId = 0;
...
require('util').inherits(PartyInvitationDungeonDetailsMessage, require('./party-invitation-details-message.js'));
