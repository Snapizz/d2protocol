...
var PartyInvitationDungeonRequestMessage = module.exports = function() {
    this.dungeonId = 0;

    return this;
};

require('util').inherits(PartyInvitationDungeonRequestMessage, require('./party-invitation-request-message.js'));
