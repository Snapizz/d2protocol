...
var PartyMemberGeoPosition = require('../../../../../types/game/context/roleplay/party/party-member-geo-position.js').PartyMemberGeoPosition;

var PartyLocateMembersMessage = function() {
    this.geopositions = [];
};

require('util').inherits(PartyLocateMembersMessage, require('./abstract-party-message.js').AbstractPartyMessage);
