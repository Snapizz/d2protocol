...
var MapCoordinatesExtended = require('../../../../../types/game/context/map-coordinates-extended.js').MapCoordinatesExtended;
...
require('util').inherits(PartyMemberInFightMessage, require('./abstract-party-message.js').AbstractPartyMessage);

module.exports = function() {
    return new PartyMemberInFightMessage();
};
