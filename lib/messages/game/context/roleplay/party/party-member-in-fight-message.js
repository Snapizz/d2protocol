...
var MapCoordinatesExtended = require('../../../../../types/game/context/map-coordinates-extended.js').class;

var PartyMemberInFightMessage = module.exports = function() {
    this.reason = 0;
    this.memberId = 0;
...
require('util').inherits(PartyMemberInFightMessage, require('./abstract-party-message.js'));
