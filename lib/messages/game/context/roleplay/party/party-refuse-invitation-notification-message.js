...
var PartyRefuseInvitationNotificationMessage = module.exports = function() {
    this.guestId = 0;

    return this;
};

require('util').inherits(PartyRefuseInvitationNotificationMessage, require('./abstract-party-event-message.js'));
