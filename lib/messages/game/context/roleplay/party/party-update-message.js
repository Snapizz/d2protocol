...
var PartyMemberInformations = require('../../../../../types/game/context/roleplay/party/party-member-informations.js').PartyMemberInformations;

var PartyUpdateMessage = function() {
    this.memberInformations = new PartyMemberInformations();
};

require('util').inherits(PartyUpdateMessage, require('./abstract-party-event-message.js').AbstractPartyEventMessage);
