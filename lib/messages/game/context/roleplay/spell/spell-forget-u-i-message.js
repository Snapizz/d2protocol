...
SpellForgetUIMessage.prototype.serializeAs_SpellForgetUIMessage = function(output) {
  param1.writeBoolean(this.open);
};

SpellForgetUIMessage.prototype.deserializeAs_SpellForgetUIMessage = function(input) {
