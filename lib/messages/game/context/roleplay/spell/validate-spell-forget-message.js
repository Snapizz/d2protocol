...
ValidateSpellForgetMessage.prototype.serializeAs_ValidateSpellForgetMessage = function(output) {
  if (this.spellId < 0) {
...
ValidateSpellForgetMessage.prototype.deserializeAs_ValidateSpellForgetMessage = function(input) {
