...
require('util').inherits(TreasureHuntDigRequestAnswerFailedMessage, require('./treasure-hunt-dig-request-answer-message.js').TreasureHuntDigRequestAnswerMessage);
