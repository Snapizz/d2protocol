...
var TreasureHuntStep = require('../../../../../types/game/context/roleplay/treasureHunt/treasure-hunt-step.js').class;
var TreasureHuntFlag = require('../../../../../types/game/context/roleplay/treasureHunt/treasure-hunt-flag.js').class;

var TreasureHuntMessage = module.exports = function() {
    this.questType = 0;
    this.startMapId = 0;
    this.knownStepsList = [];
...
require('util').inherits(TreasureHuntMessage, d2com.NetworkMessage.class);
