...
var BasicNamedAllianceInformations = require('../../../types/game/context/roleplay/basic-named-alliance-informations.js').BasicNamedAllianceInformations;
var GuildFactSheetInformations = require('../../../types/game/social/guild-fact-sheet-informations.js').GuildFactSheetInformations;
var CharacterMinimalInformations = require('../../../types/game/character/character-minimal-informations.js').CharacterMinimalInformations;

var GuildInAllianceFactsMessage = function() {
    this.allianceInfos = new BasicNamedAllianceInformations();
};

require('util').inherits(GuildInAllianceFactsMessage, require('./guild-facts-message.js').GuildFactsMessage);
