...
var GuildVersatileInformations = require('../../../types/game/social/guild-versatile-informations.js').class;

var GuildVersatileInfoListMessage = module.exports = function() {
    this.guilds = [];

    return this;
};

require('util').inherits(GuildVersatileInfoListMessage, d2com.NetworkMessage.class);
