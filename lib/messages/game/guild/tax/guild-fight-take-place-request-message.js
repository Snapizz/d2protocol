...
require('util').inherits(GuildFightTakePlaceRequestMessage, require('./guild-fight-join-request-message.js').class);
...
GuildFightTakePlaceRequestMessage.prototype.serializeAs_GuildFightTakePlaceRequestMessage = function(param1) {
    this.serializeAs_GuildFightJoinRequestMessageAs_GuildFightJoinRequestMessage(param1);
