...
var TaxCollectorFightersInformation = require('../../../../types/game/guild/tax/tax-collector-fighters-information.js').class;
...
require('util').inherits(TaxCollectorListMessage, require('./abstract-tax-collector-list-message.js').class);
...
TaxCollectorListMessage.prototype.serializeAs_TaxCollectorListMessage = function(param1) {
    this.serializeAs_AbstractTaxCollectorListMessageAs_AbstractTaxCollectorListMessage(param1);
