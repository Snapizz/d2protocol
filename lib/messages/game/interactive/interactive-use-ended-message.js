var d2com = require('d2com'),
  BaseMessage = require('./interactive-use-ended-message.js').class,
...
util.inherits(InteractiveUseEndedMessage, BaseMessage);
...
module.exports.class = InteractiveUseEndedMessage;
