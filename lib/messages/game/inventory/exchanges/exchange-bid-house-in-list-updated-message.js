...
var ObjectEffect = require('../../../../types/game/data/items/effects/object-effect.js').ObjectEffect;

var ExchangeBidHouseInListUpdatedMessage = function() {

};

require('util').inherits(ExchangeBidHouseInListUpdatedMessage, require('./exchange-bid-house-in-list-added-message.js').ExchangeBidHouseInListAddedMessage);
