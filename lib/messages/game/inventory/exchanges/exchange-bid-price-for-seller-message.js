...
var ExchangeBidPriceForSellerMessage = module.exports = function() {
...
require('util').inherits(ExchangeBidPriceForSellerMessage, require('./exchange-bid-price-message.js'));
