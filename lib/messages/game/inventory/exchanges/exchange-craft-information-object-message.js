...
require('util').inherits(ExchangeCraftInformationObjectMessage, require('./exchange-craft-result-with-object-id-message.js').ExchangeCraftResultWithObjectIdMessage);
