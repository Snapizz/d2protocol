...
require('util').inherits(ExchangeCraftResultMagicWithObjectDescMessage, require('./exchange-craft-result-with-object-desc-message.js').class);
...
ExchangeCraftResultMagicWithObjectDescMessage.prototype.serializeAs_ExchangeCraftResultMagicWithObjectDescMessage = function(param1) {
    this.serializeAs_ExchangeCraftResultWithObjectDescMessageAs_ExchangeCraftResultWithObjectDescMessage(param1);
