...
var ExchangeCraftResultMagicWithObjectDescMessage = module.exports = function() {
    this.magicPoolStatus = 0;

    return this;
};

require('util').inherits(ExchangeCraftResultMagicWithObjectDescMessage, require('./exchange-craft-result-with-object-desc-message.js'));
