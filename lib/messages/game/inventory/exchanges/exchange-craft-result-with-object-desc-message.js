...
var ExchangeCraftResultWithObjectDescMessage = module.exports = function() {
    this.objectInfo = new ObjectItemNotInContainer();

    return this;
};

require('util').inherits(ExchangeCraftResultWithObjectDescMessage, require('./exchange-craft-result-message.js'));
