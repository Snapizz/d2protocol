...
var ExchangeCraftResultWithObjectIdMessage = module.exports = function() {
    this.objectGenericId = 0;

    return this;
};

require('util').inherits(ExchangeCraftResultWithObjectIdMessage, require('./exchange-craft-result-message.js'));
