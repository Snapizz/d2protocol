...
var ObjectItemGenericQuantity = require('../../../../types/game/data/items/object-item-generic-quantity.js').class;

var ExchangeGuildTaxCollectorGetMessage = module.exports = function() {
    this.collectorName = "";
    this.worldX = 0;
    this.worldY = 0;
    this.mapId = 0;
...
require('util').inherits(ExchangeGuildTaxCollectorGetMessage, d2com.NetworkMessage.class);
