...
var ExchangeObjectModifyPricedMessage = module.exports = function() {


    return this;
};

require('util').inherits(ExchangeObjectModifyPricedMessage, require('./exchange-object-move-priced-message.js'));
