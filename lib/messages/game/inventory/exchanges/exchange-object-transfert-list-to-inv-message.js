...
var ExchangeObjectTransfertListToInvMessage = module.exports = function() {
    this.ids = [];

    return this;
};

require('util').inherits(ExchangeObjectTransfertListToInvMessage, d2com.NetworkMessage.class);
