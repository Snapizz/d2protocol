...
var ExchangePlayerMultiCraftRequestMessage = module.exports = function() {
    this.target = 0;
    this.skillId = 0;
...
require('util').inherits(ExchangePlayerMultiCraftRequestMessage, require('./exchange-request-message.js'));
