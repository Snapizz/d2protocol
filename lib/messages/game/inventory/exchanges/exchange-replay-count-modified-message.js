...
ExchangeReplayCountModifiedMessage.prototype.serializeAs_ExchangeReplayCountModifiedMessage = function(output) {
  param1.writeVarInt(this.count);
};

ExchangeReplayCountModifiedMessage.prototype.deserializeAs_ExchangeReplayCountModifiedMessage = function(input) {
