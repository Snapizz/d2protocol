...
var ExchangeShopStockMovementRemovedMessage = module.exports = function() {
    this.objectId = 0;

    return this;
};

require('util').inherits(ExchangeShopStockMovementRemovedMessage, d2com.NetworkMessage.class);
