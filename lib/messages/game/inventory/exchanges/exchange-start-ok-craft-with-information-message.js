...
require('util').inherits(ExchangeStartOkCraftWithInformationMessage, require('./exchange-start-ok-craft-message.js').class);
...
ExchangeStartOkCraftWithInformationMessage.prototype.serializeAs_ExchangeStartOkCraftWithInformationMessage = function(param1) {
    this.serializeAs_ExchangeStartOkCraftMessageAs_ExchangeStartOkCraftMessage(param1);
    if (this.nbCase < 0) {
