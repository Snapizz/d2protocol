...
var ObjectItemToSellInHumanVendorShop = require('../../../../types/game/data/items/object-item-to-sell-in-human-vendor-shop.js').class;

var ExchangeStartOkHumanVendorMessage = module.exports = function() {
    this.sellerId = 0;
    this.objectsInfos = [];
...
require('util').inherits(ExchangeStartOkHumanVendorMessage, d2com.NetworkMessage.class);
