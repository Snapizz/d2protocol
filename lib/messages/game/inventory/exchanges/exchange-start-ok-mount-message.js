...
require('util').inherits(ExchangeStartOkMountMessage, require('./exchange-start-ok-mount-with-out-paddock-message.js').class);
...
ExchangeStartOkMountMessage.prototype.serializeAs_ExchangeStartOkMountMessage = function(param1) {
    this.serializeAs_ExchangeStartOkMountWithOutPaddockMessageAs_ExchangeStartOkMountWithOutPaddockMessage(param1);
