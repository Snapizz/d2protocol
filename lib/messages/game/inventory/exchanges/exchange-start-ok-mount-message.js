...
require('util').inherits(ExchangeStartOkMountMessage, require('./exchange-start-ok-mount-with-out-paddock-message.js').ExchangeStartOkMountWithOutPaddockMessage);
