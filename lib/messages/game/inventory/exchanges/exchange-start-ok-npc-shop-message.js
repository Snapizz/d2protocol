...
var ObjectItemToSellInNpcShop = require('../../../../types/game/data/items/object-item-to-sell-in-npc-shop.js').class;

var ExchangeStartOkNpcShopMessage = module.exports = function() {
    this.npcSellerId = 0;
    this.tokenId = 0;
    this.objectsInfos = [];
...
require('util').inherits(ExchangeStartOkNpcShopMessage, d2com.NetworkMessage.class);
