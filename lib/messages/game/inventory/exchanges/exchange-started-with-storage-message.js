...
var ExchangeStartedWithStorageMessage = module.exports = function() {
    this.storageMaxSlot = 0;

    return this;
};

require('util').inherits(ExchangeStartedWithStorageMessage, require('./exchange-started-message.js'));
