...
var ExchangeTypesExchangerDescriptionForUserMessage = module.exports = function() {
    this.typeDescription = [];

    return this;
};

require('util').inherits(ExchangeTypesExchangerDescriptionForUserMessage, d2com.NetworkMessage.class);
