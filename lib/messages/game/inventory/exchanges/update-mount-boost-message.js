...
var UpdateMountBoost = require('../../../../types/game/mount/update-mount-boost.js').class;

var UpdateMountBoostMessage = module.exports = function() {
    this.rideId = 0;
...
require('util').inherits(UpdateMountBoostMessage, d2com.NetworkMessage.class);
