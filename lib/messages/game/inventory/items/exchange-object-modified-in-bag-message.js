...
var ExchangeObjectModifiedInBagMessage = module.exports = function() {
    this.object = new ObjectItem();

    return this;
};

require('util').inherits(ExchangeObjectModifiedInBagMessage, require('../exchanges/exchange-object-message.js'));
