...
var ExchangeObjectsModifiedMessage = module.exports = function() {
    this.object = [];

    return this;
};

require('util').inherits(ExchangeObjectsModifiedMessage, require('../exchanges/exchange-object-message.js'));
