...
var ExchangeObjectsRemovedMessage = module.exports = function() {
    this.objectUID = [];

    return this;
};

require('util').inherits(ExchangeObjectsRemovedMessage, require('../exchanges/exchange-object-message.js'));
