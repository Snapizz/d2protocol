...
var Preset = require('../../../../types/game/inventory/preset/preset.js').Preset;
...
require('util').inherits(InventoryContentAndPresetMessage, require('./inventory-content-message.js').InventoryContentMessage);
