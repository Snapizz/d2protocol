...
require('util').inherits(MimicryObjectFeedAndAssociateRequestMessage, require('./symbiotic-object-associate-request-message.js').SymbioticObjectAssociateRequestMessage);
