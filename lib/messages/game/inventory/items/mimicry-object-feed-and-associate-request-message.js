...
require('util').inherits(MimicryObjectFeedAndAssociateRequestMessage, require('./symbiotic-object-associate-request-message.js').class);
...
MimicryObjectFeedAndAssociateRequestMessage.prototype.serializeAs_MimicryObjectFeedAndAssociateRequestMessage = function(param1) {
    this.serializeAs_SymbioticObjectAssociateRequestMessageAs_SymbioticObjectAssociateRequestMessage(param1);
    if (this.foodUID < 0) {
