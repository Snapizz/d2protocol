...
var SymbioticObjectAssociateRequestMessage = module.exports = function() {
    this.symbioteUID = 0;
    this.symbiotePos = 0;
    this.hostUID = 0;
    this.hostPos = 0;
...
require('util').inherits(SymbioticObjectAssociateRequestMessage, d2com.NetworkMessage.class);
