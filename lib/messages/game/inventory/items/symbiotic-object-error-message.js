...
require('util').inherits(SymbioticObjectErrorMessage, require('./object-error-message.js').class);
...
SymbioticObjectErrorMessage.prototype.serializeAs_SymbioticObjectErrorMessage = function(param1) {
    this.serializeAs_ObjectErrorMessageAs_ObjectErrorMessage(param1);
