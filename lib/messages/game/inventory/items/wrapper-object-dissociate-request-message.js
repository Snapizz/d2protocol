...
var WrapperObjectDissociateRequestMessage = module.exports = function() {
    this.hostUID = 0;
    this.hostPos = 0;
...
require('util').inherits(WrapperObjectDissociateRequestMessage, d2com.NetworkMessage.class);
