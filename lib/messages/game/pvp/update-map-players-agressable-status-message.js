...
var UpdateMapPlayersAgressableStatusMessage = module.exports = function() {
    this.playerIds = [];
    this.enable = [];
...
require('util').inherits(UpdateMapPlayersAgressableStatusMessage, d2com.NetworkMessage.class);
