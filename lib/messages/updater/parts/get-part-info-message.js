...
GetPartInfoMessage.prototype.serializeAs_GetPartInfoMessage = function(output) {
  param1.writeUTF(this.id);
};

GetPartInfoMessage.prototype.deserializeAs_GetPartInfoMessage = function(input) {
