...
declare class FriendGuildSetWarnOnAchievementCompleteMessage extends NetworkMessage implements INetworkMessage {
    static ID: number;
    enable: boolean;
    constructor();
    getMessageId(): number;
...
export = FriendGuildSetWarnOnAchievementCompleteMessage;
