...
declare class FriendGuildWarnOnAchievementCompleteStateMessage extends NetworkMessage implements INetworkMessage {
    static ID: number;
    enable: boolean;
    constructor();
    getMessageId(): number;
...
export = FriendGuildWarnOnAchievementCompleteStateMessage;
