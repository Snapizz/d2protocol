...
declare class GameFightPlacementPositionRequestMessage extends NetworkMessage implements INetworkMessage {
    static ID: number;
    cellId: number;
    constructor();
    getMessageId(): number;
...
export = GameFightPlacementPositionRequestMessage;
