...
declare class GameFightPlacementSwapPositionsAcceptMessage extends NetworkMessage implements INetworkMessage {
    static ID: number;
    requestId: number;
    constructor();
    getMessageId(): number;
...
export = GameFightPlacementSwapPositionsAcceptMessage;
