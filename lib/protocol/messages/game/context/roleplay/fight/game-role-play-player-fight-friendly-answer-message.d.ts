...
declare class GameRolePlayPlayerFightFriendlyAnswerMessage extends NetworkMessage implements INetworkMessage {
    static ID: number;
    fightId: number;
    accept: boolean;
    constructor();
...
export = GameRolePlayPlayerFightFriendlyAnswerMessage;
