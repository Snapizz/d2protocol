...
declare class DungeonPartyFinderRegisterRequestMessage extends NetworkMessage implements INetworkMessage {
    static ID: number;
    dungeonIds: number[];
    constructor();
    getMessageId(): number;
...
export = DungeonPartyFinderRegisterRequestMessage;
