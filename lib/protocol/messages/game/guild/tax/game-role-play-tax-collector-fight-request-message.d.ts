...
declare class GameRolePlayTaxCollectorFightRequestMessage extends NetworkMessage implements INetworkMessage {
    static ID: number;
...
export = GameRolePlayTaxCollectorFightRequestMessage;
