...
declare class ExchangeBidHouseGenericItemRemovedMessage extends NetworkMessage implements INetworkMessage {
    static ID: number;
    objGenericId: number;
    constructor();
    getMessageId(): number;
...
export = ExchangeBidHouseGenericItemRemovedMessage;
