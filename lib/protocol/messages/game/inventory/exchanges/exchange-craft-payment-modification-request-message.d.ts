...
declare class ExchangeCraftPaymentModificationRequestMessage extends NetworkMessage implements INetworkMessage {
    static ID: number;
    quantity: number;
    constructor();
    getMessageId(): number;
...
export = ExchangeCraftPaymentModificationRequestMessage;
