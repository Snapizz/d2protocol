...
declare class ExchangeShopStockMultiMovementRemovedMessage extends NetworkMessage implements INetworkMessage {
    static ID: number;
    objectIdList: number[];
    constructor();
    getMessageId(): number;
...
export = ExchangeShopStockMultiMovementRemovedMessage;
