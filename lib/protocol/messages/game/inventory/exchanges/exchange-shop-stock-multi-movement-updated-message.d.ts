...
declare class ExchangeShopStockMultiMovementUpdatedMessage extends NetworkMessage implements INetworkMessage {
    static ID: number;
...
export = ExchangeShopStockMultiMovementUpdatedMessage;
