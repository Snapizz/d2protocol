...
declare class ExchangeMultiCraftCrafterCanUseHisRessourcesMessage extends NetworkMessage implements INetworkMessage {
    static ID: number;
    allowed: boolean;
    constructor();
    getMessageId(): number;
...
export = ExchangeMultiCraftCrafterCanUseHisRessourcesMessage;
