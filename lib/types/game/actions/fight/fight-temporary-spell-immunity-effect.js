var FightTemporarySpellImmunityEffect = module.exports = function() {
    this.immuneSpellId = 0;

    return this;
};

require('util').inherits(FightTemporarySpellImmunityEffect, require('./abstract-fight-dispellable-effect.js'));
