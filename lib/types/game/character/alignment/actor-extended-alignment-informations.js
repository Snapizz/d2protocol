...
require('util').inherits(ActorExtendedAlignmentInformations, require('./actor-alignment-informations.js').class);
...
ActorExtendedAlignmentInformations.prototype.serializeAs_ActorExtendedAlignmentInformations = function(param1) {
    this.serializeAs_ActorAlignmentInformationsAs_ActorAlignmentInformations(param1);
