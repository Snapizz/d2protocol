var ActorExtendedAlignmentInformations = module.exports = function() {
    this.honor = 0;
...
require('util').inherits(ActorExtendedAlignmentInformations, require('./actor-alignment-informations.js'));
