...
require('util').inherits(CharacterMinimalPlusLookInformations, require('./character-minimal-informations.js').class);
...
CharacterMinimalPlusLookInformations.prototype.serializeAs_CharacterMinimalPlusLookInformations = function(param1) {
    this.serializeAs_CharacterMinimalInformationsAs_CharacterMinimalInformations(param1);
