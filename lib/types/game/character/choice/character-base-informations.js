var CharacterBaseInformations = module.exports = function() {
    this.breed = 0;
    this.sex = false;
...
require('util').inherits(CharacterBaseInformations, require('../character-minimal-plus-look-informations.js'));
