var CharacterHardcoreOrEpicInformations = module.exports = function() {
    this.deathState = 0;
    this.deathCount = 0;
...
require('util').inherits(CharacterHardcoreOrEpicInformations, require('./character-base-informations.js'));
