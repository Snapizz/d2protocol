var CharacterRemodelingInformation = module.exports = function() {
    this.name = "";
    this.breed = 0;
    this.sex = false;
    this.cosmeticId = 0;
...
require('util').inherits(CharacterRemodelingInformation, require('../abstract-character-information.js'));
