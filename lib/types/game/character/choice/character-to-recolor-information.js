...
require('util').inherits(CharacterToRecolorInformation, require('./abstract-character-to-refurbish-information.js').class);
...
CharacterToRecolorInformation.prototype.serializeAs_CharacterToRecolorInformation = function(param1) {
    this.serializeAs_AbstractCharacterToRefurbishInformationAs_AbstractCharacterToRefurbishInformation(param1);
};
