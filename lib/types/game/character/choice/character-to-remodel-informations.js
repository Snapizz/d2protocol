...
require('util').inherits(CharacterToRemodelInformations, require('./character-remodeling-information.js').class);
...
CharacterToRemodelInformations.prototype.serializeAs_CharacterToRemodelInformations = function(param1) {
    this.serializeAs_CharacterRemodelingInformationAs_CharacterRemodelingInformation(param1);
