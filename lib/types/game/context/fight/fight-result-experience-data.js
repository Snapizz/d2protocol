...
require('util').inherits(FightResultExperienceData, require('./fight-result-additional-data.js').class);
...
FightResultExperienceData.prototype.serializeAs_FightResultExperienceData = function(param1) {
    this.serializeAs_FightResultAdditionalDataAs_FightResultAdditionalData(param1);
    var _loc2_ = 0;
