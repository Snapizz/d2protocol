...
require('util').inherits(FightTeamLightInformations, require('./abstract-fight-team-informations.js').class);
...
FightTeamLightInformations.prototype.serializeAs_FightTeamLightInformations = function(param1) {
    this.serializeAs_AbstractFightTeamInformationsAs_AbstractFightTeamInformations(param1);
    var _loc2_ = 0;
