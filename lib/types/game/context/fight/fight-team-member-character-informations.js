var FightTeamMemberCharacterInformations = module.exports = function() {
    this.name = "";
    this.level = 0;
...
require('util').inherits(FightTeamMemberCharacterInformations, require('./fight-team-member-informations.js'));
