...
require('util').inherits(FightTeamMemberCompanionInformations, require('./fight-team-member-informations.js').FightTeamMemberInformations);

module.exports = function() {
    return new FightTeamMemberCompanionInformations();
};
