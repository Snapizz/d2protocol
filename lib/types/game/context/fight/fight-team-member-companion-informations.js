var FightTeamMemberCompanionInformations = module.exports = function() {
    this.companionId = 0;
    this.level = 0;
    this.masterId = 0;
...
require('util').inherits(FightTeamMemberCompanionInformations, require('./fight-team-member-informations.js'));
