var FightTeamMemberMonsterInformations = module.exports = function() {
    this.monsterId = 0;
    this.grade = 0;
...
require('util').inherits(FightTeamMemberMonsterInformations, require('./fight-team-member-informations.js'));
