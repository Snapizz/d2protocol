var FightTeamMemberTaxCollectorInformations = module.exports = function() {
    this.firstNameId = 0;
    this.lastNameId = 0;
    this.level = 0;
    this.guildId = 0;
...
require('util').inherits(FightTeamMemberTaxCollectorInformations, require('./fight-team-member-informations.js'));
