...
require('util').inherits(GameFightFighterCompanionLightInformations, require('./game-fight-fighter-light-informations.js').GameFightFighterLightInformations);

module.exports = function() {
    return new GameFightFighterCompanionLightInformations();
};
