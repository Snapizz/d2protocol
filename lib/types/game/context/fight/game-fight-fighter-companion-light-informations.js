var GameFightFighterCompanionLightInformations = module.exports = function() {
    this.companionId = 0;
    this.masterId = 0;
...
require('util').inherits(GameFightFighterCompanionLightInformations, require('./game-fight-fighter-light-informations.js'));
