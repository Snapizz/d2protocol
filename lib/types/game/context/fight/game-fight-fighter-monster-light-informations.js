var GameFightFighterMonsterLightInformations = module.exports = function() {
    this.creatureGenericId = 0;

    return this;
};

require('util').inherits(GameFightFighterMonsterLightInformations, require('./game-fight-fighter-light-informations.js'));
