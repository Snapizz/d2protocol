var GameFightFighterNamedLightInformations = module.exports = function() {
    this.name = "";

    return this;
};

require('util').inherits(GameFightFighterNamedLightInformations, require('./game-fight-fighter-light-informations.js'));
