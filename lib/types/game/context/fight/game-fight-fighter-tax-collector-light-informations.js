var GameFightFighterTaxCollectorLightInformations = module.exports = function() {
    this.firstNameId = 0;
    this.lastNameId = 0;
...
require('util').inherits(GameFightFighterTaxCollectorLightInformations, require('./game-fight-fighter-light-informations.js'));
