...
require('util').inherits(GameFightMinimalStatsPreparation, require('./game-fight-minimal-stats.js').class);
...
GameFightMinimalStatsPreparation.prototype.serializeAs_GameFightMinimalStatsPreparation = function(param1) {
    this.serializeAs_GameFightMinimalStatsAs_GameFightMinimalStats(param1);
