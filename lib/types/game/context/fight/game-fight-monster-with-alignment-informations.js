var GameFightMonsterWithAlignmentInformations = module.exports = function() {
    this.alignmentInfos = new ActorAlignmentInformations();

    return this;
};

require('util').inherits(GameFightMonsterWithAlignmentInformations, require('./game-fight-monster-informations.js'));
