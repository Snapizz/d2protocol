...
require('util').inherits(GameFightMonsterWithAlignmentInformations, require('./game-fight-monster-informations.js').class);
...
GameFightMonsterWithAlignmentInformations.prototype.serializeAs_GameFightMonsterWithAlignmentInformations = function(param1) {
    this.serializeAs_GameFightMonsterInformationsAs_GameFightMonsterInformations(param1);
