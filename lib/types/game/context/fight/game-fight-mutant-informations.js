var GameFightMutantInformations = module.exports = function() {
    this.powerLevel = 0;

    return this;
};

require('util').inherits(GameFightMutantInformations, require('./game-fight-fighter-named-informations.js'));
