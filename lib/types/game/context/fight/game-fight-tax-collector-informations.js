var GameFightTaxCollectorInformations = module.exports = function() {
    this.firstNameId = 0;
    this.lastNameId = 0;
    this.level = 0;
...
require('util').inherits(GameFightTaxCollectorInformations, require('./game-fight-a-i-informations.js'));
