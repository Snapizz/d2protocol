var GameRolePlayTaxCollectorInformations = module.exports = function() {
...
require('util').inherits(GameRolePlayTaxCollectorInformations, require('./roleplay/game-role-play-actor-informations.js'));
