...
require('util').inherits(AllianceInformations, require('./basic-named-alliance-informations.js').class);
...
AllianceInformations.prototype.serializeAs_AllianceInformations = function(param1) {
    this.serializeAs_BasicNamedAllianceInformationsAs_BasicNamedAllianceInformations(param1);
