var BaseMessage = require('./alternative-monsters-in-group-light-informations.js').class,
  util = require('util');
...
util.inherits(AlternativeMonstersInGroupLightInformations, BaseMessage);
