...
require('util').inherits(BasicAllianceInformations, require('../../social/abstract-social-group-infos.js').class);
...
BasicAllianceInformations.prototype.serializeAs_BasicAllianceInformations = function(param1) {
    this.serializeAs_AbstractSocialGroupInfosAs_AbstractSocialGroupInfos(param1);
