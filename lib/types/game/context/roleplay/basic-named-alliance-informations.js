...
require('util').inherits(BasicNamedAllianceInformations, require('./basic-alliance-informations.js').class);
...
BasicNamedAllianceInformations.prototype.serializeAs_BasicNamedAllianceInformations = function(param1) {
    this.serializeAs_BasicAllianceInformationsAs_BasicAllianceInformations(param1);
