var GameRolePlayCharacterInformations = module.exports = function() {
    this.alignmentInfos = new ActorAlignmentInformations();

    return this;
};

require('util').inherits(GameRolePlayCharacterInformations, require('./game-role-play-humanoid-informations.js'));
