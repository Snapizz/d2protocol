var GameRolePlayGroupMonsterInformations = module.exports = function() {
...
require('util').inherits(GameRolePlayGroupMonsterInformations, require('./game-role-play-actor-informations.js'));
