...
require('util').inherits(GameRolePlayGroupMonsterWaveInformations, require('./game-role-play-group-monster-informations.js').GameRolePlayGroupMonsterInformations);
