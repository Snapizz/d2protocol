...
require('util').inherits(GameRolePlayGroupMonsterWaveInformations, require('./game-role-play-group-monster-informations.js').class);
...
GameRolePlayGroupMonsterWaveInformations.prototype.serializeAs_GameRolePlayGroupMonsterWaveInformations = function(param1) {
    this.serializeAs_GameRolePlayGroupMonsterInformationsAs_GameRolePlayGroupMonsterInformations(param1);
    if (this.nbWaves < 0) {
