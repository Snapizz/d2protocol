var GameRolePlayHumanoidInformations = module.exports = function() {
...
require('util').inherits(GameRolePlayHumanoidInformations, require('./game-role-play-named-actor-informations.js'));
