var GameRolePlayMerchantInformations = module.exports = function() {
    this.sellType = 0;
    this.options = [];
...
require('util').inherits(GameRolePlayMerchantInformations, require('./game-role-play-named-actor-informations.js'));
