var GameRolePlayMountInformations = module.exports = function() {
    this.ownerName = "";
    this.level = 0;
...
require('util').inherits(GameRolePlayMountInformations, require('./game-role-play-named-actor-informations.js'));
