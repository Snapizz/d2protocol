...
require('util').inherits(GameRolePlayMutantInformations, require('./game-role-play-humanoid-informations.js').class);
...
GameRolePlayMutantInformations.prototype.serializeAs_GameRolePlayMutantInformations = function(param1) {
    this.serializeAs_GameRolePlayHumanoidInformationsAs_GameRolePlayHumanoidInformations(param1);
    if (this.monsterId < 0) {
