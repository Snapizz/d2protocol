var GameRolePlayPortalInformations = module.exports = function() {
    this.portal = new PortalInformation();

    return this;
};

require('util').inherits(GameRolePlayPortalInformations, require('./game-role-play-actor-informations.js'));
