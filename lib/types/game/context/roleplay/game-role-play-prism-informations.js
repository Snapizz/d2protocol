var GameRolePlayPrismInformations = module.exports = function() {
    this.prism = new PrismInformation();

    return this;
};

require('util').inherits(GameRolePlayPrismInformations, require('./game-role-play-actor-informations.js'));
