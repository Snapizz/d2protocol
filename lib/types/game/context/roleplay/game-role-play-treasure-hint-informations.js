var GameRolePlayTreasureHintInformations = module.exports = function() {
    this.npcId = 0;

    return this;
};

require('util').inherits(GameRolePlayTreasureHintInformations, require('./game-role-play-actor-informations.js'));
