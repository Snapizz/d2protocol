var GroupMonsterStaticInformationsWithAlternatives = module.exports = function() {
    this.alternatives = [];

    return this;
};

require('util').inherits(GroupMonsterStaticInformationsWithAlternatives, require('./group-monster-static-informations.js'));
