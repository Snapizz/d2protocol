...
require('util').inherits(GroupMonsterStaticInformationsWithAlternatives, require('./group-monster-static-informations.js').class);
...
GroupMonsterStaticInformationsWithAlternatives.prototype.serializeAs_GroupMonsterStaticInformationsWithAlternatives = function(param1) {
    this.serializeAs_GroupMonsterStaticInformationsAs_GroupMonsterStaticInformations(param1);
