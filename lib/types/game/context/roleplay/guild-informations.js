...
require('util').inherits(GuildInformations, require('./basic-guild-informations.js').class);
...
GuildInformations.prototype.serializeAs_GuildInformations = function(param1) {
    this.serializeAs_BasicGuildInformationsAs_BasicGuildInformations(param1);
