...
require('util').inherits(PartyCompanionMemberInformations, require('./party-companion-base-informations.js').class);
...
PartyCompanionMemberInformations.prototype.serializeAs_PartyCompanionMemberInformations = function(param1) {
    this.serializeAs_PartyCompanionBaseInformationsAs_PartyCompanionBaseInformations(param1);
...
module.exports.getInstance = function() {
    return new PartyCompanionMemberInformations;
};