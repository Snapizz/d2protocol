var PartyCompanionMemberInformations = module.exports = function() {
    this.initiative = 0;
    this.lifePoints = 0;
...
require('util').inherits(PartyCompanionMemberInformations, require('./party-companion-base-informations.js'));
