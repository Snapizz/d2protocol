var PartyInvitationMemberInformations = module.exports = function() {
    this.worldX = 0;
    this.worldY = 0;
    this.mapId = 0;
    this.subAreaId = 0;
...
require('util').inherits(PartyInvitationMemberInformations, require('../../../character/choice/character-base-informations.js'));
