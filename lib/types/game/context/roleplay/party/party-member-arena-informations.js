...
require('util').inherits(PartyMemberArenaInformations, require('./party-member-informations.js').class);
...
PartyMemberArenaInformations.prototype.serializeAs_PartyMemberArenaInformations = function(param1) {
    this.serializeAs_PartyMemberInformationsAs_PartyMemberInformations(param1);
