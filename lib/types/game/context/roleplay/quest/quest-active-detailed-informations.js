...
require('util').inherits(QuestActiveDetailedInformations, require('./quest-active-informations.js').class);
...
QuestActiveDetailedInformations.prototype.serializeAs_QuestActiveDetailedInformations = function(param1) {
    this.serializeAs_QuestActiveInformationsAs_QuestActiveInformations(param1);
    if (this.stepId < 0) {
