...
require('util').inherits(QuestObjectiveInformationsWithCompletion, require('./quest-objective-informations.js').class);
...
QuestObjectiveInformationsWithCompletion.prototype.serializeAs_QuestObjectiveInformationsWithCompletion = function(param1) {
    this.serializeAs_QuestObjectiveInformationsAs_QuestObjectiveInformations(param1);
