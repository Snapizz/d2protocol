var TreasureHuntStepFollowDirectionToPOI = module.exports = function() {
    this.direction = 1;
    this.poiLabelId = 0;
...
require('util').inherits(TreasureHuntStepFollowDirectionToPOI, require('./treasure-hunt-step.js'));
