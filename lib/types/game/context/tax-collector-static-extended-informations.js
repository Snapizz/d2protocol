...
require('util').inherits(TaxCollectorStaticExtendedInformations, require('./tax-collector-static-informations.js').class);
...
TaxCollectorStaticExtendedInformations.prototype.serializeAs_TaxCollectorStaticExtendedInformations = function(param1) {
    this.serializeAs_TaxCollectorStaticInformationsAs_TaxCollectorStaticInformations(param1);
