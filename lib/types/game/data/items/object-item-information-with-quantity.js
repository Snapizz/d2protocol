var ObjectItemInformationWithQuantity = module.exports = function() {
    this.quantity = 0;

    return this;
};

require('util').inherits(ObjectItemInformationWithQuantity, require('./object-item-minimal-information.js'));
