...
require('util').inherits(FriendSpouseOnlineInformations, require('./friend-spouse-informations.js').class);
...
FriendSpouseOnlineInformations.prototype.serializeAs_FriendSpouseOnlineInformations = function(param1) {
    this.serializeAs_FriendSpouseInformationsAs_FriendSpouseInformations(param1);
    var _loc2_ = 0;
