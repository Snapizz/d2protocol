var TaxCollectorLootInformations = module.exports = function() {
    this.kamas = 0;
    this.experience = 0;
    this.pods = 0;
    this.itemsValue = 0;
...
require('util').inherits(TaxCollectorLootInformations, require('./tax-collector-complementary-informations.js'));
