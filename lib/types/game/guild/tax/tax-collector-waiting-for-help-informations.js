var TaxCollectorWaitingForHelpInformations = module.exports = function() {
    this.waitingForHelpInfo = new ProtectedEntityWaitingForHelpInfo();

    return this;
};

require('util').inherits(TaxCollectorWaitingForHelpInformations, require('./tax-collector-complementary-informations.js'));
