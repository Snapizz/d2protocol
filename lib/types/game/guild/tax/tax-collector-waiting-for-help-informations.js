...
require('util').inherits(TaxCollectorWaitingForHelpInformations, require('./tax-collector-complementary-informations.js').class);
...
TaxCollectorWaitingForHelpInformations.prototype.serializeAs_TaxCollectorWaitingForHelpInformations = function(param1) {
    this.serializeAs_TaxCollectorComplementaryInformationsAs_TaxCollectorComplementaryInformations(param1);
