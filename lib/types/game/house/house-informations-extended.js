...
require('util').inherits(HouseInformationsExtended, require('./house-informations.js').HouseInformations);
...
module.exports.HouseInformationsExtended = HouseInformationsExtended;