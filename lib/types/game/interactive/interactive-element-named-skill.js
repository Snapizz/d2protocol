...
require('util').inherits(InteractiveElementNamedSkill, require('./interactive-element-skill.js').class);
...
InteractiveElementNamedSkill.prototype.serializeAs_InteractiveElementNamedSkill = function(param1) {
    this.serializeAs_InteractiveElementSkillAs_InteractiveElementSkill(param1);
    if (this.nameId < 0) {
