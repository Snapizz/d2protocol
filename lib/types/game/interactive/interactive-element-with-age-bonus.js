...
require('util').inherits(InteractiveElementWithAgeBonus, require('./interactive-element.js').class);
...
InteractiveElementWithAgeBonus.prototype.serializeAs_InteractiveElementWithAgeBonus = function(param1) {
    this.serializeAs_InteractiveElementAs_InteractiveElement(param1);
