...
require('util').inherits(SkillActionDescriptionCollect, require('./skill-action-description-timed.js').class);
...
SkillActionDescriptionCollect.prototype.serializeAs_SkillActionDescriptionCollect = function(param1) {
    this.serializeAs_SkillActionDescriptionTimedAs_SkillActionDescriptionTimed(param1);
    if (this.min < 0) {
