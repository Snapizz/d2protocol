var SkillActionDescriptionCollect = module.exports = function() {
    this.min = 0;
    this.max = 0;
...
require('util').inherits(SkillActionDescriptionCollect, require('./skill-action-description-timed.js'));
