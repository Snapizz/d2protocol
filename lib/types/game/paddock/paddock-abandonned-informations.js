...
require('util').inherits(PaddockAbandonnedInformations, require('./paddock-buyable-informations.js').PaddockBuyableInformations);
...
module.exports.PaddockAbandonnedInformations = PaddockAbandonnedInformations;