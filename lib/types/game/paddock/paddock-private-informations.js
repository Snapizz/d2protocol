...
require('util').inherits(PaddockPrivateInformations, require('./paddock-abandonned-informations.js').class);
...
PaddockPrivateInformations.prototype.serializeAs_PaddockPrivateInformations = function(param1) {
    this.serializeAs_PaddockAbandonnedInformationsAs_PaddockAbandonnedInformations(param1);
