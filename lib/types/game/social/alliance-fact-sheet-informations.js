var AllianceFactSheetInformations = module.exports = function() {
    this.creationDate = 0;

    return this;
};

require('util').inherits(AllianceFactSheetInformations, require('../context/roleplay/alliance-informations.js'));
