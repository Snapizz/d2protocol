...
require('util').inherits(AllianceFactSheetInformations, require('../context/roleplay/alliance-informations.js').class);
...
AllianceFactSheetInformations.prototype.serializeAs_AllianceFactSheetInformations = function(param1) {
    this.serializeAs_AllianceInformationsAs_AllianceInformations(param1);
