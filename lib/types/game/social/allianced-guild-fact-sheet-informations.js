var AlliancedGuildFactSheetInformations = module.exports = function() {
    this.allianceInfos = new BasicNamedAllianceInformations();

    return this;
};

require('util').inherits(AlliancedGuildFactSheetInformations, require('../context/roleplay/guild-informations.js'));
