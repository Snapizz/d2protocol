...
require('util').inherits(GuildInAllianceVersatileInformations, require('./guild-versatile-informations.js').class);
...
GuildInAllianceVersatileInformations.prototype.serializeAs_GuildInAllianceVersatileInformations = function(param1) {
    this.serializeAs_GuildVersatileInformationsAs_GuildVersatileInformations(param1);
