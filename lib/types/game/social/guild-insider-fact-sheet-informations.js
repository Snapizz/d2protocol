...
require('util').inherits(GuildInsiderFactSheetInformations, require('./guild-fact-sheet-informations.js').class);
...
GuildInsiderFactSheetInformations.prototype.serializeAs_GuildInsiderFactSheetInformations = function(param1) {
    this.serializeAs_GuildFactSheetInformationsAs_GuildFactSheetInformations(param1);
