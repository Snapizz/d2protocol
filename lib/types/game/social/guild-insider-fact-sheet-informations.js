var GuildInsiderFactSheetInformations = module.exports = function() {
    this.leaderName = "";
...
require('util').inherits(GuildInsiderFactSheetInformations, require('./guild-fact-sheet-informations.js'));
